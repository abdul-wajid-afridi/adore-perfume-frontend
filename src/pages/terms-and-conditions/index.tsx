...
const TermsAndConditions = memo(() => {
  return (
    <div className="flex flex-col gap-3 sm:gap-5 p-10 ">
      <h3>TERMS AND CONDITIONS</h3>
      <p>
        Print Spot Printing / License Number: 2792428 / Contact Details: 02
        5505233 / Email: info@printspotuae.com 
      </p>
      <h3>PRINT SPOT PRINTING SERVICES LLC</h3>
      <p>
        maintains the www.adoreparfum.com Website (“Site”). The following are
        the terms of use that govern the use of the Site (“Terms of Use”). By
        using the Site you expressly agree to be bound by these Terms of Use and
        the adoreparfum.com privacy policy and to follow these Terms of Use and
        all applicable laws and regulations governing use of the Site. PRINT
        SPOT PRINTING SERVICES LLC reserves the right to change these Terms of
        Use at any time, effective immediately upon posting on the Site. Please
        check this page of the Site periodically. We will note when there are
        updates to the Terms of Use at the bottom of the Terms of Use. If you
        violate these Terms of Use, PRINT SPOT PRINTING SERVICES LLC may
        terminate your use of the Site, bar you from future use of the Site,
      ...
      <p>
        ...
        requirements and restrictions of these Terms of Use. PRINT SPOT PRINTING
        SERVICES LLC may change, suspend, or discontinue any aspect of the Site
        at any time. PRINT SPOT PRINTING SERVICES LLC may also, without notice
        or liability, impose limits on certain features and services or restrict
        your access to all or portions of the Site. You shall have no rights to
        the proprietary software and related documentation, if any, provided to
        you in order to access the Site. Except as provided in the Terms of Use,
        you shall have no right to directly or indirectly, own, use, loan, sell,
        rent, lease, license, sublicense, assign, copy, translate, modify,
      ...
      <p>
        In no case shall adore pafrum, our directors, officers, employees,
      ...
      <p>
        You agree to indemnify, defend and hold harmless adore parfum and our
